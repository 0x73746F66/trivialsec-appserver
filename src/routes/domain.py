...
def page_domain(domain_id):
    ...
    # if not domain.hydrate() or domain.account_id != current_user.account_id or domain.deleted: #domain.hydrate(query_string=f'domain_name:"{domain_name}"')
    #     return abort(404)
    ...
    #     parent_domain.hydrate() #domain.hydrate(query_string=f'domain_name:"{domain_name}"')
    #     parent_dict = {}
...
def page_domain_jobs(domain_id):
    ...
    params['account'] = current_user
    # domain = Domain(domain_id=int(domain_id))
    # if not domain.hydrate() or domain.account_id != current_user.account_id: #domain.hydrate(query_string=f'domain_name:"{domain_name}"')
    #     return abort(404)
